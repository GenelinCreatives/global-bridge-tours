...
const Footer = () => {
  ...
  return (
    <footer className="bg-offWhite text-gray-600 body-poppins">
      <div className="container px-5 py-14 mx-auto flex gap-6 md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          ...
          <p className="mt-2 text-sm text-gray-600">
            We open doors — to new destinations, new careers, and new
            chapters, both here in Kenya and far beyond.
          </p>
        </div>
